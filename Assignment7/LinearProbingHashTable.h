...
public:
    ...
    /**
     * Returns whether the specified key is contained in this hash table.
     */
...
private:
    ...
    /** Another version of function contains with the hashCode value computed beforehand. */
    bool contains(const std::string& elem, int hashCode) const;

    /** Check whether there is a filled slot with a value equal to elem in the range between start and end. */
    bool contains(const std::string& elem, int start, int end) const;
