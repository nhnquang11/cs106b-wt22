...
private:
    ...
    /**
     * Resizes the priority queue with a new given capacity.
     */
    void resize(int capacity);

    /**
     * Implements bubble-up algorithm to the node in the current index to
     * keep the priority queue in good shape.
     */
    void bubbleUp(int index);

    /**
     * Implements bubble-down algorithm to the node in the current index to
     * keep the priority queue in good shape.
     */
